  ...
  return (
    <>
      ...
      <div className="mx-5 overflow-x-auto py-2.5 px-3">
        <div className="flex w-full justify-center items-center mb-4 text-gray-600 text-xs font-semibold my-3">
      ...
      {news.map((value, index) => (
        <div
          className="mx-5 py-2.5 px-3 overflow-x-auto bg-white borber border-b-2"
          key={index}
        >
          <div className="flex w-full justify-center items-center mb-4 text-gray-600 text-xs font-semibold my-3">
            <div className="basis-1/12">
