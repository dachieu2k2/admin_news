          ...
          <nav aria-label="Page navigation example">
            <ul className="inline-flex items-center -space-x-px">
              ...
              <li>
                <a
                  href="#"
                  className="px-3 py-2 leading-tight text-white bg-primary border border-gray-300 hover:bg-primary hover:text-white "
                >
                  1
                </a>
              </li>
              ...
              <li>
                <a
                  href="#"
                  aria-current="page"
                  className="z-10 px-3 py-2 leading-tight border  bg-white text-white hover:bg-blue-100 hover:text-blue-700 "
                >
                  3
                </a>
              </li>
